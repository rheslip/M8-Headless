 ...
 K    s |         |                      |       |     |              N
      ...
      0 +----------------------------------------+   ---
        0    X-as --->
                          LEFT
*/
// this is the M8 box top
// the dimensions are hacked so don't use it for the bottom part
...
// (10) = { yappAllCorners | yappFrontLeft | yappFrondRight | yappBackLeft | yappBackRight }
 ...
 // mounting holes - connectors reduced to just a hole               
connectors   =  [
                    [ 2.5, 25.4, 0, 2.75, 2.75, 2.75,2.75, 3, 5.5, yappConnWithPCB,yappAllCorners],
                [ 24.3, 2.5, 0, 2.75, 2.75, 2.75, 2.75, 3, 5.5, yappConnWithPCB,yappAllCorners]
                ];
...
// (5) = { yappRectangle | yappCircle }
// (6) = { yappCenter }
// using pcbWidth- distance from left edge of top for Y
// because the top prints face down ie mirrored in Y
// switches are on 2.54" grid which helps locate relative to each other
cutoutsBase = [
                    [9, 5, 91, 57, 0, yappRectangle] // lcd hole
                  , [73.5,pcbWidth- 25, 7, 7, 0, yappRectangle] // shutdown switch hole
                  , [82.5,pcbWidth- 92, 18, 17, 0, yappRectangle] //edit switch
                  , [82.5,pcbWidth- 92 + 8*2.54, 18, 17,, 0, yappRectangle] //option switch
                  , [85,pcbWidth- 92 + 17*2.54, 18, 17, 0, yappRectangle] //up switch
                  , [85+8*2.54,pcbWidth- 92 + 17*2.54, 18, 17, 0, yappRectangle] //down switch
                  , [85+8*2.54,pcbWidth- 92 + 17*2.54 -8*2.54, 18, 17, 0, yappRectangle] //right switch
                  , [85+8*2.54,pcbWidth- 92 + 17*2.54 +8*2.54 +0.5, 18, 17, 0, yappRectangle] //left switch
                  , [85+16*2.54,pcbWidth- 92 + 17*2.54 -8*2.54, 18, 17, 0, yappRectangle] //play switch
                  , [85+16*2.54,pcbWidth- 92 + 17*2.54, 18, 17, 0, yappRectangle] //shift switch
              ];
