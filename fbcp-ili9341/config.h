...
#define LOW_BATTERY_PIN 17
// RH added battery gauge inputs for 3/4 and half battery so total 4 battery states
#define HALF_BATTERY_PIN 27
#define THREEQ_BATTERY_PIN 22
